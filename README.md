...
[Про взлом RSA ключа на классическом компьютере](https://eprint.iacr.org/2010/006.pdf)

[Как победить квантовый компьютер с помощью WebAssembly?](https://www.youtube.com/watch?v=4_lVq1-lr8g)

## Существующие квантовые компьютеры:

[D-WAVE](https://www.dwavesys.com/home)

[Успехи РКЦ](https://nplus1.ru/news/2019/04/01/quantum-transition)
...
### Поиграться с реальными квантовыми компьютерами:

[Quantum Experience](https://quantumexperience.ng.bluemix.net/qx/editor)
